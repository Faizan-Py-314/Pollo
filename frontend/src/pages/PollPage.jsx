                    ...
                    <div className='px-5 py-3 lg:ml-4 md:pr-3.5 xl:pr-6'>
                        ...
                        <div className='md:flex md:gap-3 xl:gap-10'>
                            <div className='md:w-[60%] xl:w-[65%] xl:ml-5'>
                                ...
                                <div className='border p-4 flex flex-col rounded-md gap-3 mt-2 xl:mt-5 xl:p-6 xl:gap-4'>
                                    <span className='text-sm font-bold -my-2 xl:text-base xl:-mb-1'>Options</span>
                                    <div className='w-full border rounded-md p-2 flex gap-2 items-center xl:p-3 xl:px-4 xl:gap-3'>
                                        <div className='w-4 h-4 border rounded-full flex items-center justify-center xl:w-5 xl:h-5 xl:border-2'>
                                            <div className='w-2.5 h-2.5 rounded-full bg-black xl:w-3 xl:h-3'></div>
                                        </div>
                                ...
                                <div className='border rounded-md p-2 flex flex-col gap-3 mt-3 xl:mt-7 xl:p-4'>
                                    ...
                                    <div className='ml-2 flex flex-col gap-3 xl:gap-5'>
                                        <div className='poll flex items-center gap-2'>
                                            <div className='w-3 h-3 border rounded-full flex items-center justify-center xl:w-4 xl:h-4'>
                                                <div className='w-2 h-2 rounded-full bg-black xl:w-2.5 xl:h-2.5'></div>
                                            </div>
                                            <div className='w-[82%] h-3 border rounded-2xl sm:w-[90%] xl:h-4'>
                                                <div className='bg-black h-full w-[50%] rounded-2xl'></div>
                                            </div>
                            ...
                            <div className='border w-full h-[90vh] mb-3 p-4 mt-3 rounded-md flex flex-col relative md:w-[40%] md:mt-0 md:h-[85vh] xl:w-[30%]'>
