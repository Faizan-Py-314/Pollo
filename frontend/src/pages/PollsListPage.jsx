...
const PollsListPage = () => {
  ...
  return (
    <>
      <div className='px-5 py-3 lg:ml-4 lg:max-w-[1600px] mx-auto'>
        ...
        <div className='w-full container flex flex-col  mt-3 gap-4 p-2 h-[75vh] overflow-auto lg:gap-6 [@media(min-height:900px)]:h-[81vh]'>
          ...
          {polls.map((poll, index) => (
            <div onClick={() => navigate(`/poll/${poll.id}`)} key={poll.id} className='bg-[#FFFFFF] hover:bg-gray-100 cursor-pointer w-full h-12 shadow-md rounded-md flex items-center text-sm p-4 justify-between text-start md:text-base lg:text-lg md:p-6 lg:p-8 lg:px-12 lg:pr-20'>
              ...
              <div className='flex-1 w-0 flex justify-center items-center'>
                <span className='flex gap-1 items-center lg:text-sm bg-green-200 text-xs p-1 px-1.5 lg:p-1.5 rounded-sm lg:rounded-md'>
